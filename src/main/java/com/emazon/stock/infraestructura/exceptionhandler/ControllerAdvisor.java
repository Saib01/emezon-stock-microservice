...
public class ControllerAdvisor {
    ...
    public ResponseEntity<Map<String, String>> handleErrorNoDescription(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(MESSAGE, ExceptionResponse.CATEGORY_DESCRIPTION_REQUIRED.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, String>> handleErrorNoDescription(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(MESSAGE, ExceptionResponse.CATEGORY_NAME_REQUIRED.getMessage()));
    }

    @ExceptionHandler(CategoryNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleErrorNoFound(CategoryNotFoundException categoryNotFoundException) {
    ...
    public ResponseEntity<Map<String, String>> handleErrorInvalidSortDirection(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(MESSAGE, ExceptionResponse.SORT_DIRECTION_IS_INVALID.getMessage()));
    }
