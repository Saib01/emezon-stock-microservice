...
class CategoryMapperTest {
    ...
    /*
     * default Page<CategoryResponse> toCategoryResponsePage(PageStock<Category>
     * categoryPageStock) {
     * 
     * Pageable pageable = PageRequest.of(
     * categoryPageStock.getPageNumber(),
     * categoryPageStock.getPageSize(),
     * Sort.by(Sort.Direction.fromString(categoryPageStock.getSortDirection()),
     * categoryPageStock.getSortBy())
     * );
     * return new PageImpl<>(
